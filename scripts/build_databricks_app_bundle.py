...
Type-D audio, Timeline, presentation/workflow and final simplification
...
from ikf.app_simplification_adoption import (
    SIMPLIFICATION_ADOPTION_VERSION,
...
def build_bundle(output: Path) -> Path:
    ...
    transformed_app_source, applied_simplification = transform_app_simplification_source(
        transformed_app_source
    )
    ...
    manifest = {
        "bundle_contract": "IKF_DATABRICKS_APP_BUNDLE_V0.8",
    ...
    required = [
        ...
        bundle_package / "app_simplification_adoption.py",
